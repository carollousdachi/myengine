...
<head>
    ...
    <title>Sistem Informasi Surveyor</title>
    <link rel="icon" type="image/png" href="asset/img/logo/icon pelindo.png" />
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="../../index2.html"><b>Sistem Informasi</b>&nbsp;Pelindo</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
